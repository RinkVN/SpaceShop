                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm mb-2 mb-sm-0">
                            ...
                            <h1 class="page-header-title">Edit Books</h1>
                        ...
                        <div class="col-lg-8 mb-3 mb-lg-0">
                            ...
                            <div class="card mb-3 mb-lg-5">
                                ...
                                <div class="card-header">
                                    <h4 class="card-header-title">Book information</h4>
                                </div>
                                <!-- End Header -->
                                ...
                                <div class="card-body">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="productNameLabel" class="form-label">Book Name 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <!-- Form -->
                                            <div class="mb-4">
                                                <label for="weightLabel" class="form-label">Author Name</label>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="productNameLabel" class="form-label">Publisher
                                            <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Publishing Company."></i></label>
                                        <input
                                            name="publisher"
                                            type="text"
                                            class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <!-- Form -->
                                            <div class="mb-4">
                                                <label for="SKULabel" class="form-label">Language</label>

                                                <input 
                                                    type="text" class="form-control" 
                                                    name="language" id="SKULabel" 
                                        ...
                                        <div class="col-sm-6">
                                            <!-- Form -->
                                            <div class="mb-4">
                                                <label for="weightLabel" class="form-label">Page Number</label>
                                    ...
                                    <label class="form-label">About The Author <span class="form-label-secondary">(Optional)</span></label>
                                    ...
                                    <div class="quill-custom">
                                        ...
                                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                            ...
                                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                                <label for="editor" class="sr-only">Publish post</label>
                                                <textarea 
                                                    name="descriptionAuthor" id="editor" rows="8" 
                                                    class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..."  
                                                    /><%= b.getDescriptionAuthor() %></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <label class="row form-check form-switch" for="availabilitySwitch1">
                                        ...
                                        <span class="col-4 col-sm-3 text-end">
                                            <div class="tom-select-custom">
                                                <select name="bstatus" class="js-select form-select" autocomplete="off" id="categoryLabel"
                                                        data-hs-tom-select-options='{
                                                        "searchInDropdown": false,
                                                        "hideSearch": true,
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="vendorLabel" class="form-label">Quantity</label>

                                        <input 
                                            type="text" class="form-control" 
                                            name="quantity" id="vendorLabel" 
                                            value="<%= b.getQuantity() %>"
                                            >
                                    </div>
                                    <!-- End Form -->
                                    ...
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="categoryLabel" class="form-label">Choose Category</label>

                                        <!-- Select -->

                                        <div class="tom-select-custom">
                                            <select name="categories" class="js-select form-select" autocomplete="off" id="categoryLabel"
                                                    data-hs-tom-select-options='{
                                                    "searchInDropdown": false,
                                                    "hideSearch": true,
                                                    "placeholder": "Select category"
                                                ...
                                                <option selected="selected"><%= b.getBookCategory() %></option>
